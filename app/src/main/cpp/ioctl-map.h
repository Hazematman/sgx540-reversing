char* ioctl_names1[] = {
    ...
    "PVRSRV_BRIDGE_CREATE_COMMANDQUEUE (dummy)",
    "PVRSRV_BRIDGE_DESTROY_COMMANDQUEUE (dummy)",
    "PVRSRV_BRIDGE_MHANDLE_TO_MMAP_DATA",
    "PVRSRV_BRIDGE_CONNECT_SERVICES",
    "PVRSRV_BRIDGE_DISCONNECT_SERVICES",
    "PVRSRV_BRIDGE_WRAP_DEVICE_MEM (dummy)",
    "PVRSRV_BRIDGE_GET_DEVICEMEMINFO (dummy)",
    "PVRSRV_BRIDGE_RESERVE_DEV_VIRTMEM (dummy)",
    "PVRSRV_BRIDGE_FREE_DEV_VIRTMEM (dummy)",
    "PVRSRV_BRIDGE_MAP_EXT_MEMORY (dummy)",
    "PVRSRV_BRIDGE_UNMAP_EXT_MEMORY dummy",
    ...
    "RESERVED",
    "RESERVED",
    "PVRSRV_BRIDGE_PROCESS_SIMISR_EVENT (dummy)",
    "PVRSRV_BRIDGE_REGISTER_SIM_PROCESS (dummy)",
    "PVRSRV_BRIDGE_UNREGISTER_SIM_PROCESS (dummy)",
    "PVRSRV_BRIDGE_MAPPHYSTOUSERSPACE (dummy)",
    "PVRSRV_BRIDGE_UNMAPPHYSTOUSERSPACE (dummy)",
    "PVRSRV_BRIDGE_GETPHYSTOUSERSPACEMAP (dummy)",
    "PVRSRV_BRIDGE_GET_FB_STATS (dummy)",
    "PVRSRV_BRIDGE_GET_MISC_INFO",
    "PVRSRV_BRIDGE_RELEASE_MISC_INFO (dummy)",
    "PVRSRV_BRIDGE_GET_OEMJTABLE (dummy)",
    ...
    "PVRSRV_BRIDGE_GET_DISPCLASS_SYSBUFFER (dummy)",
